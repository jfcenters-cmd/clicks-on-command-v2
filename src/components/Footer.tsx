  ...
  return (
    <footer className="relative border-t border-white/[0.06] py-12">
      ...
      <Container className="flex flex-col gap-8">
        ...
        <div className="flex flex-col items-start justify-between gap-4 border-t border-white/[0.06] pt-6 text-[12px] text-foreground/40 md:flex-row md:items-center">
