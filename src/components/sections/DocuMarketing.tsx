...
export function DocuMarketing() {
  return (
    <section
      id="documarketing"
      className="scroll-mt-nav relative overflow-hidden py-20 sm:py-24"
    >
      <div
        aria-hidden
      ...
      <Container size="narrow">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <motion.h2
            ...
            className="mt-4 font-display text-[clamp(1.85rem,4.5vw,2.85rem)] leading-[1.08] tracking-tight text-balance"
          >
        ...
        <motion.div
          ...
          className="mx-auto mt-10 max-w-2xl space-y-5 text-pretty text-[15px] leading-[1.75] text-foreground/75 sm:text-[16px]"
        >
          <p>
        ...
        >
          <GlassCard className="border-accent/25 bg-gradient-to-b from-accent/[0.06] to-transparent p-7 sm:p-8">
        ...
        <motion.div
          ...
          className="mx-auto mt-8 max-w-2xl space-y-5 text-pretty text-[15px] leading-[1.75] text-foreground/75 sm:text-[16px]"
        >
          <p>
        ...
        <div className="mx-auto mt-10 grid max-w-4xl gap-3 sm:mt-12 md:grid-cols-3">
          {outcomes.map((o, i) => (
            <motion.div
              key={o.title}
              initial={{ opacity: 0, y: 16 }}
            ...
            >
              <div className="h-full rounded-2xl border border-white/[0.08] bg-white/[0.02] p-5 sm:p-6">
        ...
        <motion.p
          ...
          className="mx-auto mt-8 max-w-2xl text-center font-mono text-[10px] uppercase tracking-[0.2em] text-foreground/40"
        >
